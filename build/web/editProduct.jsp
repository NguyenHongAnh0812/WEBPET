        ...
        <div class="container">
            ...
            <div class="container1">
                ...
                <div class="box" id="preview">
                    <img src="${c.getImage()}" width="100%" height="100%" alt="alt"/>
                </div>
                <div class="box">

                    <form id="productForm" method="post" action="EditProductServlet">
                        <label for="image">Chọn ảnh:</label>
                        <input type="file" id="image" name="image" accept="image/*" value="${c.getImage()}" >
                        ...
                        <input type="number" id="price" name="price" value="${c.getPrice()}" required>



                        <input type="hidden" id="image1" name="image1" value="${c.getImage()}">
